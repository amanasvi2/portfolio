        ...
        <div className="mt-4 space-y-2">
          {project.features.map((feature, idx) => (
            <div key={idx} className="flex items-start">
              <Code2 className="w-5 h-5 text-pretty-blue mr-2 mt-1 flex-shrink-0" />
...
const ProjectsSection = () => {
  ...
  const projects = [
      {
        title: "Georgia Tech Student Toolkit Chatbot",
        description: "A chatbot that centralizes information from 30+ Georgia Tech webpages, improving student access to resources.",
        features: [
          "Built with Java and Git integrated with LLMs.",
          "Improved user experience by centralizing scattered campus information.",
        ],
        technologies: ["Java", "Git", "LLMs"],
        image: "/gt-student-toolkit.png",
        github: "",
        live: ""
      },
      {
        title: "WanderSync",
        description: "Android app that simplifies travel itinerary creation for individuals and groups.",
        features: [
          "Created in Java and XML using Android Studio.",
          "Enhanced planning efficiency with collaborative itinerary building."
        ],
